...
import { forgetCatalog, loadRegistry } from './registry.js';
...
import { addProfileBundle, hasLoadableEntry, INBOX_BUNDLES, isDshProfileName, profileDir, readInstalled, readInstalledManifest, readInstalledRepoEvidence, readInstalledVersion, readLockCommits, readManifestDeps, readProfileBundles, removeProfileBundle, restoreManifestDeps, setAllowBuilds } from './profile.js';
...
import { codeloadAllowBuildsKey, findInstalledAlias, gitAllowBuildsKey, installTargetFor, repoOfTarget } from './sources.js';
...
import { checkUpdates, fetchNpmLatest, invalidateUpdates, isUpgrade, latestPublishedRecently, setUpdateRegistry, versionOnChannel } from './updates.js';
