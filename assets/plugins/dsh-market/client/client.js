window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		var Market_module_css_default = {
			...
			"empty": "eGUBIq_empty",
			"err": "eGUBIq_err",
			"exportLogBtn": "eGUBIq_exportLogBtn",
			...
			"tag": "eGUBIq_tag",
			"themeActions": "eGUBIq_themeActions",
			"themeCard": "eGUBIq_themeCard",
			"themeCardBody": "eGUBIq_themeCardBody",
			"themeCardFooter": "eGUBIq_themeCardFooter",
			"themeCardHead": "eGUBIq_themeCardHead",
			"themeCover": "eGUBIq_themeCover",
			"themeCoverEmpty": "eGUBIq_themeCoverEmpty",
			"themeDescription": "eGUBIq_themeDescription",
			"themeFullscreenBtn": "eGUBIq_themeFullscreenBtn",
			"themeGallery": "eGUBIq_themeGallery",
			"themeIdentity": "eGUBIq_themeIdentity",
			"themeLifecycle": "eGUBIq_themeLifecycle",
			"themePreviewAction": "eGUBIq_themePreviewAction",
			"themePreviewCount": "eGUBIq_themePreviewCount",
			"themeResultBar": "eGUBIq_themeResultBar",
			"themeSearch": "eGUBIq_themeSearch",
			"themesGrid": "eGUBIq_themesGrid",
			"themeStatus": "eGUBIq_themeStatus",
			"themeStatusMuted": "eGUBIq_themeStatusMuted",
			"themeToolbar": "eGUBIq_themeToolbar",
			"themeToolbarActions": "eGUBIq_themeToolbarActions",
			"title": "eGUBIq_title",
		...
		*/
		function ThemeCover({ plugin, onOpen, t }) {
			...
			if (visible.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				"aria-label": `${name}: ${t("themePreviewMissing")}`,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconSparkle16, { size: 20 }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("themePreviewMissing") })]
			});
			const src = visible[0];
